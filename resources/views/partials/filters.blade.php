<div class="form-group row">
    ...
    <div class="mb-3 col-6">
        <label for="family_type" class="form-label h5">Family Type</label>
...
<div class="form-group row">
    <div class="mb-3 col-6">
        <label for="annual_income" class="form-label h5">Annual Income ₹ </label>
    ...
    <div class="mb-3 col-6">
        <label for="exampleInputPassword1" class="form-label h5">Manglik</label>
